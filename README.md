...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/little-bird-3fec#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/little-bird-3fec
```

A live public deployment of this template is available at [https://little-bird-3fec.templates.workers.dev](https://little-bird-3fec.templates.workers.dev)
